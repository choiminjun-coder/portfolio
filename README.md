...
안녕하세요, Unity 기반의 게임 시스템을 직접 설계하고 구현해 온 개발자 최민준입니다.
지난 4년간 TPS, FPS, 퍼즐 등 다양한 장르의 프로젝트를 주도하며, 캐릭터 제어부터 전투 시스템, 상태 이상 처리, UI 연동까지 전체 게임 루프를 실전 수준으로 구현한 경험을 보유하고 있습니다.
<br>
