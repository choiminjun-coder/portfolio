...
- **장르**: 1인칭 FPS + 서바이벌  
- **참여 인원**: 개인 개발  
- **기획/프로그래밍/시스템 구성**을 모두 단독으로 구현  
- 플레이어는 총기를 활용해 적을 처치하며 생존 시간을 늘려 점수를 획득하고,  
  주변에서 랜덤하게 등장하는 아이템으로 능력을 강화할 수 있음  
...
- **모든 시스템을 클래스 단위로 분리**하여 확장성과 유지보수성 확보
