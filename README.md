...
지난 3년간 TPS, FPS, 퍼즐 등 다양한 장르의 프로젝트를 주도하며, 캐릭터 제어부터 전투 시스템, 상태 이상 처리, UI 연동까지 전체 게임 루프를 실전 수준으로 구현한 경험을 보유하고 있습니다.<br>
디자이너 및 팀원과의 협업을 통해 기획 의도에 맞춘 기능 구현과 최적화를 수행했으며, 실무 중심의 포트폴리오를 기반으로 즉시 투입 가능한 Unity 개발 인재로 성장해왔습니다.<br>
<br>
